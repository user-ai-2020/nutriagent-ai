      ...
      messages: [
        {
          ...
          content: [
            ...
            "Translate meal types (breakfast/lunch/dinner/snack) and food item names into the target language.",
            "If a food name is already a placeholder like Nothing/unknown/no food, OMIT that item — never invent words like empty/nothing in the target language.",
            "If you cannot confidently translate a real food name, keep the original English name rather than inventing a wrong word.",
